    ...
    return (
        <>
            ...
            <div className="Main-text">
                ...
                각 항목의 최소 레벨은 0이고 결정화를 제외한 최대 레벨은 10이다.<br />
    ...
    return (
        <>
            ...
            <div className="Main-text">
                ...
                돌풍: 레벨 상승시마다 <mark>화력 (force)과 게이지 충전 속도가 증가</mark>한다.<br />
                약체화: 레벨 상승시마다 <mark>임팩테이블의 최소 충격량 값 (limit)이 감소</mark>한다.<br />
                결정화: 레벨 상승시마다 <mark>HP가 1씩 증가하고 퓨어 오브의<br />
                크기 (scale)와 범위가 증가</mark>한다. (유일하게 최대 레벨이 5이다.)<br />
            </div>
        </>
    );
}
    ...
    return (
        <>
            ...
            <div className="Main-text">
                ...
                오브의 기본 하트는 3개이며, HP가 0이 되면 <mark>게임 오버</mark>된 뒤<br />
