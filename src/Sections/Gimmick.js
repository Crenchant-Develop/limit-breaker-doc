...
function Gimmick() {
    return (
        <>
            <div className="Image">
                <img className="Image-right" src="https://i.ibb.co/ch3LSSF/gimmick.png" alt="gimmick" border="0" />
            </div>
...
function Gimmick3() {
    return (
        <>
            <div className="Image">
                <img className="Image-right" src="https://i.ibb.co/ChdrHpW/gimmick1.png" alt="gimmick1" border="0" />
            </div>
            <div className="Main-text">
...
function Gimmick4() {
    return (
        <>
            <div className="Image">
                <img className="Image-right" src="https://i.ibb.co/8sZ2Frd/gimmick2.png" alt="gimmick2" border="0" />
            </div>
            <div className="Main-text">
...
function Gimmick5() {
    return (
        <>
            <div className="Image">
                <img className="Image-right" src="https://i.ibb.co/mymdfvP/gimmick3.png" alt="gimmick3" border="0" />
            </div>
            <div className="Main-text">
...
function Gimmick6() {
    return (
        <>
            <div className="Image">
                <img className="Image-right" src="https://i.ibb.co/xgRZKRT/gimmickX.png" alt="gimmickX" border="0" />
            </div>
            <div className="Main-text">
...
function Gimmick7() {
    return (
        <>
            <div className="Image">
                <img className="Image-right" src="https://i.ibb.co/g7yPDmn/gimmick4.png" alt="gimmick4" border="0" />
            </div>
            <div className="Main-text">
...
function Gimmick9() {
    return (
        <>
            <div className="Image">
                <img className="Image-right" src="https://i.ibb.co/gt7Fn05/gimmick6.png" alt="gimmick6" border="0" />
            </div>
            <div className="Main-text">
...
function Gimmick11() {
    return (
        <>
            <div className="Image">
                <img className="Image-right" src="https://i.ibb.co/JFBk3dw/gimmick8.png" alt="gimmick8" border="0" />
            </div>
            <div className="Main-text">
