            ...
            render={({ state, fullpageApi }) => {
                return (
                    <div>
                        ...
                        <Section>
                            <MainContext number="02" title="강화 옵션" content={System2()} />
                        </Section>

                        <Section>
                            <MainContext number="04" title="강화 옵션" content={System3()} />
                        </Section>

                        <Section>
                            <MainContext number="05" title="퓨어 오브 - 게이지" content={System4()} />
                        </Section>

                        <Section>
                            <MainContext number="06" title="퓨어 오브 - 게이지 공식" content={System5()} />
                        </Section>

                        <Section>
                            <MainContext number="07" title="퓨어 오브 - 하트" content={System6()} />
                        </Section>

                        <Section>
                            <MainContext number="08" title="임팩테이블" content={System7()} />
                        </Section>

                        <Section>
                            <MainContext number="09" title="임팩테이블 - 스탯" content={System8()} />
                        </Section>

                        <Section>
                            <MainContext number="10" title="임팩테이블 - 충격량" content={System9()} />
                        </Section>
                        ...
                        <Section>
                            <MainContext number="12" title="임팩테이블의 종류" content={System11()} />
                        </Section>

                        <Section>
                            <MainContext number="13" title="임팩테이블의 종류" content={System12()} />
                        </Section>
                        ...
                        <Section>
                            <MainContext number="16" title="슈가코인" content={System15()} />
                        </Section>
